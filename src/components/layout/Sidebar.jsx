...
export default function Sidebar() {
  ...
  return (
    <div className="w-64 bg-fin-card border-r border-fin-border flex flex-col h-full shrink-0 shadow-2xl lg:shadow-none">
      ...
      <div className="p-4 border-t border-[#1F1F1F] flex flex-col gap-3 mt-auto bg-[#0A0A0A]">
        {/* GitHub Link */}
        <a 
          href="https://github.com/khanirfan18" 
          target="_blank" 
          rel="noopener noreferrer" 
          className="flex items-center justify-center gap-3 w-full px-4 py-3 text-sm font-bold tracking-widest transition-all duration-200 border border-[#1F1F1F] text-gray-400 hover:text-white hover:border-[#FF6B00]/50"
          title="GitHub"
        >
